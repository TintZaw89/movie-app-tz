...
<%User u = (User)session.getAttribute("userobj"); %>
	...
	<div class="container-fluid">
		<div class="row p-3">
			...
			List<MovieDtls> list = dao.getMoviesBySearch(ch);
			...
			<div class="col-md-3">
				<div class="card crd-ho mt-2">
					<div class="card-body text-center">
						...
						if (m.getQuantity() > 0) {
						%>
						<p><a href="cart?mid=<%=m.getMovieId()%>&&uid=<%=u.getId()%>&&pid=search_movies" class="btn btn-danger btn-sm"><i class="fas fa-cart-plus"></i> Add Cart</a> <a href="view_movies.jsp?mid=<%=m.getMovieId()%>" class="btn btn-success btn-sm">View Details</a></p>
						<%
						} else {
						%>
